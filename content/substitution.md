...
Euler's opening example: given $y = \dfrac{1 - z^2}{1 + z^2}$, let $z = \dfrac{1 - x}{1 + x}$. Substituting yields $y = \dfrac{2x}{1 + x^2}$. At $x = \tfrac{1}{2}$: $z = \tfrac{1}{3}$ and $y = \tfrac{4}{5}$, consistent with $y = (1 - z^2)/(1 + z^2)$ at $z = \tfrac{1}{3}$ (source: chapter3, §46).
